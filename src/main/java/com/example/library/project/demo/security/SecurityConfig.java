                ...
                .authorizeHttpRequests(
                        authorizationManagerRequestMatcherRegistry ->
                                authorizationManagerRequestMatcherRegistry
                                        ...
                                        .requestMatchers("/loan/user/*/current").hasAnyRole("LIBRARIAN", "READER")
                                        .requestMatchers("/loan/user/*/history").hasAnyRole("LIBRARIAN", "READER")
                                        .requestMatchers("/loan/book/*").hasRole("LIBRARIAN")
